...
public class AdminRestController {
    ...
    public ResponseEntity saveRole(@RequestBody RequestSaveUserRoleDto requestSaveUserRoleDto) throws NoDataInListException, OutOfPageException, UserNotFoundException {
        ...
        PageDto pageDto = userService.getListUserFirstLoad( requestSaveUserRoleDto.getPage(), 2);
        return ResponseEntity.ok(PageDto.builder().resultList(pageDto.getResultList()).roles(roleService.findAll()).build());
    }
}
